...
<div class="practice-sb04 cf">
	<p class="practice-sbt">入部について</p>
	<ul class="cf">
		<li>１．規約に同意の上、所定の入部申込書に記入捺印をして学年委員に提出してください。</li>
		<li>２．会費は、農協引き落としのため、農協にて口座を開設し口座振替の手続きをお願いいたします。</li>
		<li>３．練習用Tシャツを発注して下さい。原則として上は花野井Tシャツ、下は赤、 靴下は赤です。<br />
				　　ボールは４号球、スパイク、すね当て、バックも必要です。</li>
		<li>４．３年生以上は、別に試合用ユニフォーム上下を貸し出しします。１年間着用しますので、大切に扱って下さい。<br />
				　　試合用ソックスは別に購入していただきます。</li>
		<li>５．入部記念として、ジュニサカ保険料初年度(４月～３月)分は当クラブで負担いたします。</li>
		<li>６．普段の健康管理を大切にするとともに、保護者のご協力を心よりお願い申し上げます。</li>
	</ul>
</div>
<div class="practice-sb05 cf">
	<p class="practice-sbt">選手登録について</p>
	<ul class="cf">
		<li>１．柏市サッカー協会の規定により、市内・市外を問わず、複数チームでの選手登録はできないことになっております。</li>
		<li>２．花野井サッカークラブで選手登録をした場合、他のチームでの協会主催の公式戦出場は出来ません。</li>
		<li>３．他のチームで選手登録をした場合、花野井サッカークラブでは協会主催の公式戦には出場出来ません。</li>
		<li>４．練習参加には問題ありませんが、複数チームに参加されている方は、選手登録の有無をお知らせ下さい。</li>
		<li>５．二重登録が判明した場合、登録された双方のチームにご迷惑をかけることとなります。</li>
		<li>６．例年２月中旬頃、次年度の選手登録をします。高学年から選手登録をするチームが多いようなので、該当者はご注意下さい。</li>
	</ul>
</div>
</div>
</div>
